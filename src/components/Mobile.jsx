  ...
  return (
    ...
    <div className='absolute top-40 right-40'>
      ...
      <div className="flex flex-col items-center justify-center h-screen">
        <h1 className="text-9xl font-extrabold z-10 relative tracking-wider">
          CASH
        </h1>
        <div className="absolute z-10 w-40">
          <img src="/assets/phone.png" className="" />
        </div>
        <h1 className="text-9xl font-extrabold z-10 relative tracking-wider">
          APP
        </h1>
    ...
    <div className='absolute bottom-0 left-0'>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 justify-center items-center w-full absolute 2xl:bottom-2 3xl:bottom-10 px-4 bg-black">
        <div className="flex px-4">
          <button className="px-4 font-bold border-white border rounded-md mx-1 py-2 flex items-center z-10 bg-black">
            <svg
              width="20"
              height="24"
              viewBox="0 0 20 24"
        ...
        <div className="flex items-center my-5">
          <p className="text-xs font-thin px-2">
          ...
          <ul className="flex">
            <li className="px-2">
              <svg
                ...
                xmlns="http://www.w3.org/2000/svg"
              >
                <g id="Frame" clip-path="url(#clip0_114_52)">
                  <path
                    id="Vector"
                    fill-rule="evenodd"
                    clip-rule="evenodd"
            ...
            <li className="px-2">
              <svg
                ...
                xmlns="http://www.w3.org/2000/svg"
              >
                <g id="Frame" clip-path="url(#clip0_114_54)">
                  <path
                    id="Vector"
            ...
            <li className="px-2">
              <svg
                ...
                xmlns="http://www.w3.org/2000/svg"
              >
                <g id="Frame" clip-path="url(#clip0_114_56)">
                  <path
                    id="Vector"
                    fill-rule="evenodd"
                    clip-rule="evenodd"
